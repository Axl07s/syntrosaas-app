...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-TBBLZ766.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-SGSXZWCH.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-4UIILZLP.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-J6TY2J3M.js")).default(client, argv, telemetry);
    default:
