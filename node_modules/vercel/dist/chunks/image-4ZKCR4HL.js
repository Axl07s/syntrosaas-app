...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-ALX26ARH.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-K2NJD2AI.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-4KAI42EX.js")).default(client, args, telemetry);
    default:
